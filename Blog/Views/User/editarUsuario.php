<?php use Utils\Utils;?>
<?php if(isset($_SESSION['UsuarioActualizado']) && $_SESSION['UsuarioActualizado'] == 'complete'): ?>
    <strong>Usuario editado correctamente</strong>
<?php elseif(isset($_SESSION['UsuarioActualizado']) && $_SESSION['UsuarioActualizado'] == 'failed'):?>
    <strong>No se ha podido editar el Usuario</strong>
<?php endif;?>
<?php Utils::deleteSession('UsuarioActualizado');?>
